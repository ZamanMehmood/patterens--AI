...
//       {/* Sidebar */}
//       <aside className="w-20 bg-gray-800 text-white flex flex-col items-center py-6 space-y-6">
//         <div className="text-xl font-bold">A</div>
//         <nav className="flex flex-col gap-6 mt-10">
//           <button title="Dashboards" className="hover:text-blue-400">🏠</button>
//           <button title="Users" className="hover:text-blue-400">👤</button>
//           <button title="Models" className="hover:text-blue-400">📊</button>
//           <button title="Settings" className="hover:text-blue-400">⚙️</button>
//           <button title="Audit Log" className="hover:text-blue-400">📜</button>
//         </nav>
//       </aside>
